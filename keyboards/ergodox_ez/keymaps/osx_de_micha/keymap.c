...
[BASE]=KEYMAP(
    ...
    KC_LSFT,      MT(MOD_LGUI | MOD_LALT, DE_OSX_Y), DE_OSX_X, DE_OSX_C, DE_OSX_V, DE_OSX_B, KC_VOLD /* vol- */,
    ...
    KC_PAUS /* heller */, DE_OSX_Z, DE_OSX_U, DE_OSX_I,    DE_OSX_O,   DE_OSX_P,    DE_OSX_UE,
             DE_OSX_H, DE_OSX_J, DE_OSX_K,    DE_OSX_L,   DE_OSX_OE,   DE_OSX_AE,
    KC_F14 /* dunkler */, DE_OSX_N, DE_OSX_M, DE_OSX_COMM, DE_OSX_DOT, DE_OSX_MINS, KC_RSFT,
                       KC_SPC,   KC_RALT,     KC_RGUI,    KC_F13,      KC_F15,
    KC_MNXT, KC_MPLY,
    MEH_T(KC_NO) /* ctrl+shift+alt */,
    KC_RALT /* ctrl+shift */, KC_RCTL, MO(SYMB)),
[SYMB]=KEYMAP(
    //left half
...
[NAVI]=KEYMAP(
    ...
    KC_TRNS,     MT(MOD_LGUI | MOD_LALT, KC_ESC),  KC_TAB,  KC_INS,  KC_ENT,  LGUI(DE_OSX_Z),   KC_TRNS,
                          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                                                     KC_TRNS, KC_TRNS,
                                                              KC_TRNS,
                                            KC_TRNS, KC_TRNS, KC_TRNS,
