...
[BASE]=KEYMAP(
    ...
    TG(SYMB), DE_OSX_A, DE_OSX_S, DE_OSX_D, DE_OSX_F, DE_OSX_G,
    TG(SYMB), DE_OSX_Y, DE_OSX_X, DE_OSX_C, DE_OSX_V, DE_OSX_B, KC_VOLD /* vol- */,
    KC_F13,   KC_F14,   KC_LCTL,  KC_LALT,  KC_LGUI,
                                            KC_MUTE,  KC_MPRV /* prev */,
                                                      KC_NO  /* KC_SYSTEM_SLEEP reserved */,
                                  KC_LSFT,  TG(NAVI), KC_ENT,
    //right half
    ...
    KC_PAUS, DE_OSX_N, DE_OSX_M, DE_OSX_COMM, DE_OSX_DOT, DE_OSX_MINS, TG(SYMB),
                       KC_SPC,   KC_RALT,     KC_RGUI,    KC_F15,      KC_F16,
    KC_MNXT, KC_MPLY,
    MEH_T(KC_NO) /* ctrl+shift+alt */,
    C_S_T(KC_NO) /* ctrl+shift */, KC_RCTL, TG(SYMB)),
[SYMB]=KEYMAP(
    //left half
